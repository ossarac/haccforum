...
router.get('/recent', optionalAuthenticate, getRecentArticles)
router.get('/topic-stats', optionalAuthenticate, getTopicStatistics)
...
router.post('/', authenticate, requireAnyRole('admin', 'editor', 'viewer'), createArticle)
